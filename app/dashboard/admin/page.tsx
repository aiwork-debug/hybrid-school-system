  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col justify-between">
      <div>
        ...
        {/* Tabs: Teachers / Students / Courses */}
        <div className="w-full px-6 sm:px-12 max-w-[105rem] mx-auto pb-20">
          <AdminTabs teachers={teachers} students={students} courses={courses} />
        </div>
      </div>
